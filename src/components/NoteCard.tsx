...
const NoteCard = ({ note, onEdit, onDelete }: NoteCardProps) => {
    return (
        <div
            onClick={onEdit}
            className={`relative text-center rounded-lg
                        text-xl
            ...
            {note ? (
                <>
                    ...
                    {/* Hover quill SVG icon */}
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center pt-10">
                        <svg
                            ...
                            viewBox="0 0 512 512"
                            fill="none"
                            className="text-zinc-700 group-hover:scale-125 transition-transform duration-300"
                        >
                            <path
                    ...
                    <div className="absolute inset-0 flex flex-col items-center pt-8 px-4 text-lg pointer-events-none">
                        <p className="block font-serif italic text-gray-800 break-words text-center line-clamp-3 w-full">{note.title}</p>
                    </div>
                </>
            ) :
                <>
                    ...
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center pt-8 text-zinc-700">
                        <div className="group-hover:scale-150 transition-transform duration-300">
                            <svg
                                className="h-10 w-10"
                                viewBox="0 0 497.616 497.616"
                            >
                                <g id="XMLID_116_">
                                    <path id="XMLID_118_" d="M470.314,392.915l-40.059-0.264c-0.043,0-0.083,0-0.117,0c-9.308,0-16.885,7.512-16.944,16.828
                                    c-0.058,9.365,7.473,16.993,16.829,17.06l18.814,0.123c-5.874,10.357-16.995,17.357-29.727,17.383h-0.141
